...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { code: @subject.code, name: @subject.name, short: @subject.short } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { code: @subject.code, name: @subject.name, short: @subject.short } }
